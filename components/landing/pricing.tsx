  ...
  return (
    <section className="flex flex-col mt-36">
      ...
      <div className="flex flex-col lg:flex-row justify-around gap-y-4">
        <div className="text-center flex flex-col justify-between bg-[#090202] min-h-[40rem] p-6 rounded-sm min-w-[20rem] lg:min-w-[15rem] mx-auto lg:w-[18rem]">
          <div>
        ...
        <div className="text-center flex flex-col justify-between bg-primary/40 min-h-[40rem] p-6 rounded-sm min-w-[20rem] lg:min-w-[15rem] mx-auto lg:w-[18rem]">
          <div>
